...
begin
  if (RadioButton1.Checked = True) and (Edit5.Text <> '') then
    begin
      Dm.ADOQDataMekanik.Filtered := False;
      DM.ADOQDataMekanik.Filter :='idMekanik LIKE '+Quotedstr('%'+Edit5.Text+'%');
      Dm.ADOQDataMekanik.Filtered := True;
    end
  else
  if (RadioButton2.Checked = True) and (Edit5.Text <> '') then
    begin
      Dm.ADOQDataMekanik.Filtered := False;
      DM.ADOQDataMekanik.Filter :='namaMekanik LIKE '+Quotedstr('%'+Edit5.Text+'%');
      Dm.ADOQDataMekanik.Filtered := True;
    end
  else
  if (RadioButton3.Checked = True) and (Edit5.Text <> '') then
    begin
      Dm.ADOQDataMekanik.Filtered := False;
      DM.ADOQDataMekanik.Filter :='noTelpon LIKE '+Quotedstr('%'+Edit5.Text+'%');
      Dm.ADOQDataMekanik.Filtered := True;
    end
  else
  if (RadioButton4.Checked = True) and (Edit5.Text <> '') then
    begin
      Dm.ADOQDataMekanik.Filtered := False;
      DM.ADOQDataMekanik.Filter :='Alamat LIKE '+Quotedstr('%'+Edit5.Text+'%');
      Dm.ADOQDataMekanik.Filtered := True;
    end
  else
    begin
